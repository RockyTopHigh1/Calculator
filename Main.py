...
btn_multi = tk.Button(root, text="*", command=lambda: add_to_calculation("*"), width=5, font=("Ariel", 14))
...
btn_equal = tk.Button(root, text="=", command=lambda: evaluate_calculation(), width=7, font=("Ariel", 14))
btn_equal.grid(row=6, column=1, columnspan=2)
btn_clear = tk.Button(root, text="C", command=lambda: clear_field(), width=7, font=("Ariel", 14))
